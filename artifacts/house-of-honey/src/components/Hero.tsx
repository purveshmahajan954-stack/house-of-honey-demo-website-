...
const Hero = () => {
  ...
  return (
    <section className="relative w-full pt-48 pb-12 px-4 md:px-8 bg-background flex flex-col items-center overflow-hidden min-h-[90vh]">
      ...
      >
        <motion.h1 
          className="font-display font-black text-center tracking-tighter w-full text-foreground whitespace-nowrap overflow-visible flex justify-center text-[150px]"
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}
        >
          HOUSE<span className="font-serif italic font-normal text-[110px] lowercase opacity-90 relative top-[8px] tracking-normal mx-[8px]" style={{ fontFamily: "'Cormorant Garamond', serif" }}>of</span>HONEY
        </motion.h1>
      </motion.div>
