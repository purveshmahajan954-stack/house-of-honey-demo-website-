  ...
  return (
    <footer id="contact" className="w-full bg-[#0E0E0E] text-[#EDCCBE] pt-16 md:pt-28 pb-8 px-5 md:px-12 border-t border-[#EDCCBE]/10">
      <div className="max-w-[1400px] mx-auto">
        ...
        {/* Top Grid */}
        <motion.div
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-8 mb-16 md:mb-24"
        ...
        >
          {/* Logo & tagline */}
          <div className="col-span-1 sm:col-span-2 md:col-span-1 flex flex-col gap-4 mb-4 md:mb-0">
          ...
          {/* Connect */}
          <div className="flex flex-col gap-2 font-sans col-span-1 sm:col-span-2 md:col-span-1">
            ...
            @bombayhawkfitness</a>
            <a href="mailto:info@bombayhawkfitness.com" className="text-sm opacity-70 hover:opacity-100 transition-opacity break-all">
